 ...
 */
@RemoteView
public class McProgressBar extends View {
    ...
    public McProgressBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mUiThreadId = Thread.currentThread().getId();
        initProgressBar();

        TypedArray a =
            context.obtainStyledAttributes(attrs, R.styleable.McProgressBar, defStyle, 0);
        
        mNoInvalidate = true;
        
        Drawable drawable = a.getDrawable(R.styleable.McProgressBar_progressDrawable);
        if (drawable != null) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.McProgressBar_minWidth, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.McProgressBar_maxWidth, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.McProgressBar_minHeight, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.McProgressBar_maxHeight, mMaxHeight);

       
        setMax(a.getInt(R.styleable.McProgressBar_max, mMax));

        setProgress(a.getInt(R.styleable.McProgressBar_progress, mProgress));

        setSecondaryProgress(
                a.getInt(R.styleable.McProgressBar_secondaryProgress, mSecondaryProgress));
...
//            StateListDrawable in = (StateListDrawable) drawable;
     ...
     */
    public Drawable tileifyIndeterminate(Drawable drawable) {
    ...
    public void invalidateDrawable(Drawable dr) {
        if (!mInDrawing) {
            if (verifyDrawable(dr)) {
                ...
                final int scrollX = mScrollX + getPaddingLeft();
                final int scrollY = mScrollY + getPaddingTop();
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link McProgressBar#onSaveInstanceState()}
         */
